-- ==== 20260825141000_boardbuddy_full_setup.sql ====
-- ENUM
...
('trial3', 'Starter', '3 days full access', 4900, 3, 'pro',
 '["3D models library","Concept videos","Ad-free experience","All mock tests","NCERT solutions","Progress analytics","Formula sheets"]'::jsonb, 1),
('month1', 'Monthly', '1 month full access', 49900, 30, 'pro',
 '["3D models library","Concept videos","Ad-free experience","All mock tests","NCERT solutions","Progress analytics","Formula sheets"]'::jsonb, 2),
...
('maxpro', 'Max Pro', 'Everything + AI tutor', 259900, 365, 'max',
 '["Everything in Yearly","AI doubt-solving tutor","Priority support","Blue tick on your name","Early access to new features"]'::jsonb, 4);
...
-- ==== 20260825141752_47c68418-8839-4c70-9433-74448d76eefd.sql ====
GRANT EXECUTE ON FUNCTION public.reset_password_with_answer(text, text, text) TO anon, authenticated;
-- ==== 20260827001834_dc588d13-7811-4fb5-ae08-5d1d761a3234.sql ====
